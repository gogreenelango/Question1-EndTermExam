...
public class Question1 extends ECE {
	public static void main(String[] args){
		...
		case 2:
		{
			...
			Courses e = new Mechanical();
			System.out.println(e.displayCourseDetails("Mechaniacal"));//call the function of the class that you initialized
			break;
		}
		case 3:
		{
